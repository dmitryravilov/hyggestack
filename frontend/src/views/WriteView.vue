  ...
  <div class="min-h-screen bg-primary">
    ...
    <main class="container mx-auto px-4 py-12">
      <div class="max-w-6xl mx-auto">
        <h1 class="text-3xl font-serif text-primary mb-8">Write a New Post</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <!-- Preview -->
          <div class="bg-secondary rounded-lg shadow-lg p-6">
            <h2 class="text-xl font-serif text-primary mb-4">Preview</h2>
            <div
...
function savePost() {
  ...
  console.log('Saving post:', { title: title.value, content: content.value })
}
</script>
